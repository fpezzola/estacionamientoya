...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("estacionamientoya");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("estacionamientoya");
        ...
        config.getMapConfigs().put("ar.com.rubix.estacionamientoya.domain.*", initializeDomainMapConfig(jHipsterProperties));
